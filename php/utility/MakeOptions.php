...
// DietlyapiIntegration SDK utility: make_options

class DietlyapiIntegrationMakeOptions
{
    ...
    public static function call(DietlyapiIntegrationContext $ctx): array
    {
        ...
        //
        // `DietlyapiIntegrationSchema::optspec()` is built from the model:
        ...
        $optspec = DietlyapiIntegrationSchema::optspec();
