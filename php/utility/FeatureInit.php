...
// DietlyapiIntegration SDK utility: feature_init

class DietlyapiIntegrationFeatureInit
{
    public static function call(DietlyapiIntegrationContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
