...
// DietlyapiIntegration SDK utility type

class DietlyapiIntegrationUtility
{
    ...
    public static function copy(DietlyapiIntegrationUtility $src): DietlyapiIntegrationUtility
    {
        $u = new DietlyapiIntegrationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
