...
// DietlyapiIntegration SDK Barcode entity
...
class BarcodeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BarcodeEntity($this->_client, $opts);
    }

    /**
     * @param Barcode|array $args Barcode data (assoc-array) to store.
     */
    ...
    /**
     * @return Barcode|array The current Barcode data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Barcode fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Barcode fields).
     */
    ...
    /**
     * Load a single Barcode.
     *
     * @param BarcodeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BarcodeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Barcode|array The loaded Barcode as an assoc-array at the
