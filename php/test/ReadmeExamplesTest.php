...
// DietlyapiIntegration SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DietlyapiIntegrationSDK::test)
...
{
    private const SDK_CLASS = 'DietlyapiIntegrationSDK';
    ...
    private const SDK_BASE = 'dietlyapiintegration_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../dietlyapiintegration_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
