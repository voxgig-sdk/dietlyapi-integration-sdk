...
class BarcodeDirectTest extends TestCase
{
    public function test_direct_load_barcode(): void
    {
        $setup = barcode_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-barcode", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function barcode_direct_setup($mockres)
{
