...
// DietlyapiIntegration SDK pipeline test
//
...
{
    private static function utility(): DietlyapiIntegrationUtility
    {
        return new DietlyapiIntegrationUtility();
    }
    ...
    private static function ctx(array $over = []): DietlyapiIntegrationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new DietlyapiIntegrationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new DietlyapiIntegrationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof DietlyapiIntegrationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new DietlyapiIntegrationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = DietlyapiIntegrationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new DietlyapiIntegrationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = DietlyapiIntegrationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new DietlyapiIntegrationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = DietlyapiIntegrationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DietlyapiIntegrationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = DietlyapiIntegrationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new DietlyapiIntegrationResponse([]),
            'result' => new DietlyapiIntegrationResult([]),
        ]);
        [, $err] = DietlyapiIntegrationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new DietlyapiIntegrationSpec([]),
            'response' => null,
            'result' => new DietlyapiIntegrationResult([]),
        ]);
        [, $err] = DietlyapiIntegrationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new DietlyapiIntegrationSpec(['step' => 's']),
            'response' => new DietlyapiIntegrationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new DietlyapiIntegrationResult([]),
        ]);
        [, $err] = DietlyapiIntegrationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new DietlyapiIntegrationSpec(['step' => 's']),
            'response' => new DietlyapiIntegrationResponse(self::resp(200, ['v' => 1])),
            'result' => new DietlyapiIntegrationResult([]),
        ]);
        [, $err] = DietlyapiIntegrationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new DietlyapiIntegrationSpec(['step' => 's']),
            'response' => new DietlyapiIntegrationResponse(self::resp(200, ['v' => 2])),
            'result' => new DietlyapiIntegrationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        DietlyapiIntegrationMakeResponse::call($ctx);
    ...
    {
        $preset = new DietlyapiIntegrationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new DietlyapiIntegrationSpec([]),
            'response' => new DietlyapiIntegrationResponse([]),
            'result' => new DietlyapiIntegrationResult([]),
        ...
        [$got, $err] = DietlyapiIntegrationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new DietlyapiIntegrationResult([])]);
        [, $err] = DietlyapiIntegrationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new DietlyapiIntegrationSpec([]), 'result' => null]);
        [, $err] = DietlyapiIntegrationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DietlyapiIntegrationSpec(['step' => 's']),
            'result' => new DietlyapiIntegrationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new DietlyapiIntegrationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DietlyapiIntegrationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DietlyapiIntegrationSpec(['step' => 's']),
            'result' => new DietlyapiIntegrationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new DietlyapiIntegrationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DietlyapiIntegrationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DietlyapiIntegrationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new DietlyapiIntegrationSpec([]),
            'result' => new DietlyapiIntegrationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = DietlyapiIntegrationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DietlyapiIntegrationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new DietlyapiIntegrationError('boom', 'boom');
        $utility->fetcher = function (DietlyapiIntegrationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DietlyapiIntegrationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = DietlyapiIntegrationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (DietlyapiIntegrationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = DietlyapiIntegrationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(DietlyapiIntegrationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        DietlyapiIntegrationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (DietlyapiIntegrationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DietlyapiIntegrationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = DietlyapiIntegrationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new DietlyapiIntegrationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new DietlyapiIntegrationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = DietlyapiIntegrationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = DietlyapiIntegrationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = DietlyapiIntegrationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new DietlyapiIntegrationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, DietlyapiIntegrationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new DietlyapiIntegrationResult(['ok' => false])]);
        $this->expectException(DietlyapiIntegrationError::class);
        DietlyapiIntegrationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new DietlyapiIntegrationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', DietlyapiIntegrationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        DietlyapiIntegrationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new DietlyapiIntegrationBaseFeature();
        $b = new DietlyapiIntegrationBaseFeature();
        DietlyapiIntegrationFeatureAdd::call($ctx, $a);
        DietlyapiIntegrationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): DietlyapiIntegrationBaseFeature
    {
        $f = new DietlyapiIntegrationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        DietlyapiIntegrationFeatureAdd::call($ctx, self::named_feature('a'));
        DietlyapiIntegrationFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        DietlyapiIntegrationFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        DietlyapiIntegrationFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        DietlyapiIntegrationFeatureAdd::call($ctx, $replace);
        ...
        DietlyapiIntegrationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): DietlyapiIntegrationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new DietlyapiIntegrationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DietlyapiIntegrationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        DietlyapiIntegrationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new DietlyapiIntegrationResponse(['headers' => null]),
            'result' => new DietlyapiIntegrationResult([]),
        ]);
        DietlyapiIntegrationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        DietlyapiIntegrationResultBody::call($ctx);
