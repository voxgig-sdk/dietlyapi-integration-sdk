...
class MetaEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DIETLYAPIINTEGRATION_TEST_META_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function meta_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DIETLYAPIINTEGRATION_TEST_META_ENTID");
