...
class BarcodeEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DIETLYAPIINTEGRATION_TEST_BARCODE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function barcode_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DIETLYAPIINTEGRATION_TEST_BARCODE_ENTID");
