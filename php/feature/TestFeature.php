...
// DietlyapiIntegration SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DietlyapiIntegrationTestFeature extends DietlyapiIntegrationBaseFeature
{
    ...
    public function init(DietlyapiIntegrationContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DietlyapiIntegrationContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DietlyapiIntegrationParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DietlyapiIntegrationContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DietlyapiIntegrationContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = DietlyapiIntegrationParam::call($ctx, $k);
