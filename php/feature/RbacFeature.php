...
// DietlyapiIntegration SDK rbac feature
...
class DietlyapiIntegrationRbacFeature extends DietlyapiIntegrationBaseFeature
{
    ...
    private function _required(DietlyapiIntegrationContext $ctx): ?string
    {
    ...
    private function _reject(DietlyapiIntegrationContext $ctx, string $required): void
    {
    ...
    private function _track(DietlyapiIntegrationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
