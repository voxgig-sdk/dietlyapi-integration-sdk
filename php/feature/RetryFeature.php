...
// DietlyapiIntegration SDK retry feature
...
class DietlyapiIntegrationRetryFeature extends DietlyapiIntegrationBaseFeature
{
    ...
    public function init(DietlyapiIntegrationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DietlyapiIntegrationContext $ctx2, string $url, array $fetchdef) use ($inner): array {
            return $this->_with_retry($ctx2, $url, $fetchdef, $inner);
        };
    }

    private function _with_retry(DietlyapiIntegrationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(DietlyapiIntegrationContext $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;
