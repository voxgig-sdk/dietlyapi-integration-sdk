...
// DietlyapiIntegration SDK cache feature
...
class DietlyapiIntegrationCacheFeature extends DietlyapiIntegrationBaseFeature
{
    ...
    private function _through(DietlyapiIntegrationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
