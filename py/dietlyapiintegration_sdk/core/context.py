...
from dietlyapiintegration_sdk.core.control import DietlyapiIntegrationControl
...
from dietlyapiintegration_sdk.core.helpers import get_ctx_prop, to_map
...
class DietlyapiIntegrationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = DietlyapiIntegrationControl()
        ...
        if isinstance(sp, DietlyapiIntegrationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DietlyapiIntegrationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DietlyapiIntegrationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return DietlyapiIntegrationOperation({})
        ...
        op = DietlyapiIntegrationOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return DietlyapiIntegrationError(code, msg, self)
