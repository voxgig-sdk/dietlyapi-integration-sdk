# DietlyapiIntegration SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DietlyapiIntegrationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DietlyapiIntegrationSDK(...) and DietlyapiIntegrationSDK.test(...) become
#      DietlyapiIntegrationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dietlyapiintegration_sdk"
_SDK_CLASS = "DietlyapiIntegrationSDK"
