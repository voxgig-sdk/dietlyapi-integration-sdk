// Command DietlyapiIntegration-mcp is an MCP server exposing the DietlyapiIntegration
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DietlyapiIntegration_list  — list records of an entity
//	DietlyapiIntegration_load  — load a single record of an entity
//
