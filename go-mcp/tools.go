...
type Args struct {
	Entity string         `json:"entity" jsonschema:"barcode | food | meta | popular | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DietlyapiIntegrationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "dietlyapi-integration_list",
		Description: "List records from DietlyapiIntegration. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "dietlyapi-integration_load",
		Description: "Load a single record from DietlyapiIntegration. " +
...
func runOp(client *sdk.DietlyapiIntegrationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DietlyapiIntegrationSDK, name string) (sdk.DietlyapiIntegrationEntity, error) {
	switch strings.ToLower(name) {
	case "barcode":
		return client.Barcode(nil), nil
	case "food":
		return client.Food(nil), nil
	case "meta":
