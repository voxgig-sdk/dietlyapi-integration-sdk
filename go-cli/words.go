...
func registerSDKWords(r *eng.Registry, client *sdk.DietlyapiIntegrationSDK) {
...
func runOp(client *sdk.DietlyapiIntegrationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
