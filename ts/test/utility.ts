...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.DIETLYAPIINTEGRATION_TEST_LIVE ||
    'TRUE' === process.env.DIETLYAPIINTEGRATION_TEST_OVERRIDE
  ) {
  ...
  m.DIETLYAPIINTEGRATION_TEST_EXPLAIN = process.env.DIETLYAPIINTEGRATION_TEST_EXPLAIN || m.DIETLYAPIINTEGRATION_TEST_EXPLAIN
