...
describe('FoodEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    let food_ref01_data = Object.values(setup.data.existing.food)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/food/FoodTestData.json')
