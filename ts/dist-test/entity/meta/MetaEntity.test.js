...
(0, node_test_1.describe)('MetaEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [{ "active": true, "name": "foods_in_db", "req": false, "type": "`$INTEGER`", "index$": 0 }, { "active": true, "name": "status", "req": false, "type": "`$STRING`", "index$": 1 }], "name": "meta", "op": { "load": { "input": "data", "name": "load", "points": [{ "active": true, "args": {}, "contract": { "id": "GET /health", "json": "{\"operationId\":\"health\",\"parameters\":[],\"protocol\":\"http\",\"responses\":{\"200\":{\"content\":{\"application/json\":{\"example\":{\"foods_in_db\":4749433,\"status\":\"ok\"},\"schema\":{\"properties\":{\"foods_in_db\":{\"type\":\"integer\"},\"status\":{\"type\":\"string\"}},\"type\":\"object\"}}},\"description\":\"Service status and database size\"}},\"security\":[{},{\"bearerAuth\":[]}],\"securitySchemes\":{\"bearerAuth\":{\"description\":\"Optional for the endpoints in this spec. Get a free key instantly at https://www.getdietly.com/account (no card required).\",\"scheme\":\"bearer\",\"type\":\"http\"}},\"securitySource\":\"definition\"}", "source": "openapi3", "version": 1 }, "kind": "http", "method": "GET", "orig": "/health", "segments": [{ "lit": "health" }], "select": {}, "transform": { "req": "`reqdata`", "res": "`body`" }, "index$": 0 }], "key$": "load" } }, "relations": { "ancestors": [] }, "key$": "meta", "name__orig": "meta", "Name": "Meta", "name_": "meta", "name-": "meta", "NAME": "META", "index$": 2 }, { "active": true, "entity": "meta", "key$": "BasicMetaFlow", "kind": "basic", "name": "BasicMetaFlow", "param": {}, "step": [{ "active": true, "data": {}, "input": { "ref": "meta_ref01", "srcdatavar": "meta_ref01_data", "suffix": "_dt0" }, "match": {}, "op": "load", "spec": [], "valid": [{ "apply": "TextFieldMark", "def": { "mark": "Mark01-meta_ref01" } }], "index$": 0 }] }, 'Meta');
        }
...
function basicSetup(extra) {
    ...
    idmap = env['DIETLYAPI_INTEGRATION_TEST_META_ENTID'];
    const live = 'TRUE' === env.DIETLYAPI_INTEGRATION_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['DIETLYAPI_INTEGRATION_TEST_META_ENTID'];
