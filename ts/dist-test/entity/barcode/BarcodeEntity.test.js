...
(0, node_test_1.describe)('BarcodeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(barcode_ref01_data_dt0.id === barcode_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/barcode/BarcodeTestData.json');
    ...
    let idmap = transform(['barcode01', 'barcode02', 'barcode03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    if (live) {
        const rawIds = process.env['DIETLYAPI_INTEGRATION_TEST_BARCODE_ENTID'];
...
//# sourceMappingURL=BarcodeEntity.test.js.map