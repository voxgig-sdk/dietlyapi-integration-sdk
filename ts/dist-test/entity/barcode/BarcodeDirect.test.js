...
(0, node_test_1.describe)('BarcodeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-barcode', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-barcode', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            params.id = "0855088005245";
        }
        else {
            params.id = 'direct01';
        }
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DIETLYAPI_INTEGRATION_TEST_BARCODE_ENTID'];
...
//# sourceMappingURL=BarcodeDirect.test.js.map