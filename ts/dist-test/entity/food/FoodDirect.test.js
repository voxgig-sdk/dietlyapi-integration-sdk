...
(0, node_test_1.describe)('FoodDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DietlyapiIntegrationSDK({
    ...
    (0, node_test_1.test)('direct-load-food', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-food', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-food', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-food', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.DIETLYAPI_INTEGRATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DietlyapiIntegrationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.DIETLYAPI_INTEGRATION_APIKEY,
        }));
        let idmap = env['DIETLYAPI_INTEGRATION_TEST_FOOD_ENTID'];
    ...
    const client = new __1.DietlyapiIntegrationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=FoodDirect.test.js.map