...
function envOverride(m) {
    if ('TRUE' === process.env.DIETLYAPI_INTEGRATION_TEST_LIVE ||
        'TRUE' === process.env.DIETLYAPI_INTEGRATION_TEST_OVERRIDE) {
    ...
    m.DIETLYAPI_INTEGRATION_TEST_EXPLAIN = process.env.DIETLYAPI_INTEGRATION_TEST_EXPLAIN || m.DIETLYAPI_INTEGRATION_TEST_EXPLAIN;
    return m;
}
