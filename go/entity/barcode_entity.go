...
func NewBarcodeEntity(client *core.DietlyapiIntegrationSDK, entopts map[string]any) *BarcodeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BarcodeEntity) GetName() string { return e.name }
...
func (e *BarcodeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BarcodeEntity) Deleted() bool {
	return e.deleted
}


func (e *BarcodeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBarcodeEntity(e.client, opts)
}

func (e *BarcodeEntity) Data(args ...any) any {
...
func (e *BarcodeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Barcode; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BarcodeEntity) DataTyped(data ...Barcode) Barcode {
	if len(data) > 0 {
		return typedFrom[Barcode](e.Data(asMap(data[0])))
	}
	return typedFrom[Barcode](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Barcode (all fields
// optional at the wire level).
func (e *BarcodeEntity) MatchTyped(match ...Barcode) Barcode {
	if len(match) > 0 {
		return typedFrom[Barcode](e.Match(asMap(match[0])))
	}
	return typedFrom[Barcode](e.Match())
}
...
func (e *BarcodeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BarcodeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BarcodeLoadMatch and returns an Barcode. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BarcodeEntity) LoadTyped(reqmatch BarcodeLoadMatch, ctrl map[string]any) (Barcode, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Barcode{}, err
	}
	return typedFrom[Barcode](res), nil
}



func (e *BarcodeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BarcodeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BarcodeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BarcodeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BarcodeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
