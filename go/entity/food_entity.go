...
type FoodEntity struct {
	name    string
	client  *core.DietlyapiIntegrationSDK
...
func NewFoodEntity(client *core.DietlyapiIntegrationSDK, entopts map[string]any) *FoodEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FoodEntity) GetName() string { return e.name }
...
func (e *FoodEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FoodEntity) Deleted() bool {
	return e.deleted
}


func (e *FoodEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFoodEntity(e.client, opts)
}

func (e *FoodEntity) Data(args ...any) any {
...
func (e *FoodEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Food; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FoodEntity) DataTyped(data ...Food) Food {
	if len(data) > 0 {
		return typedFrom[Food](e.Data(asMap(data[0])))
	}
	return typedFrom[Food](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Food (all fields
// optional at the wire level).
func (e *FoodEntity) MatchTyped(match ...Food) Food {
	if len(match) > 0 {
		return typedFrom[Food](e.Match(asMap(match[0])))
	}
	return typedFrom[Food](e.Match())
}
...
func (e *FoodEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FoodEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FoodLoadMatch and returns an Food. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FoodEntity) LoadTyped(reqmatch FoodLoadMatch, ctrl map[string]any) (Food, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Food{}, err
	}
	return typedFrom[Food](res), nil
}




func (e *FoodEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// FoodListMatch and returns []Food. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FoodEntity) ListTyped(reqmatch FoodListMatch, ctrl map[string]any) ([]Food, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Food](res), nil
}



func (e *FoodEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FoodEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FoodEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FoodEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
