...
const testSeed = `map[string]any{"entity": map[string]any{"barcode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "food": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "meta": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "popular": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
