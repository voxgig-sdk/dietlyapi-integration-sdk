...
class DietlyapiIntegrationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DietlyapiIntegrationTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = DietlyapiIntegrationTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = DietlyapiIntegrationTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
