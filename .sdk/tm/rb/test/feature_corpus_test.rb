# DietlyapiIntegration SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # DietlyapiIntegrationSDK.new, not DietlyapiIntegrationSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    DietlyapiIntegrationSDK.new(opts)
  end
