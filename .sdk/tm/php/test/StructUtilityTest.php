...
// DietlyapiIntegration SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DietlyapiIntegrationOmni::makeStructRunner(
    ...
    {
        return DietlyapiIntegrationOmni::objmodel(DietlyapiIntegrationOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return DietlyapiIntegrationOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return DietlyapiIntegrationOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DietlyapiIntegrationOmni::structfix($now, Struct::undef()))
                        !== json_encode(DietlyapiIntegrationOmni::structfix($val, Struct::undef()))) {
