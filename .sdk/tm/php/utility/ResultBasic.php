...
// DietlyapiIntegration SDK utility: result_basic

class DietlyapiIntegrationResultBasic
{
    public static function call(DietlyapiIntegrationContext $ctx): ?DietlyapiIntegrationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof DietlyapiIntegrationError) ? $result->err->msg : (string)$result->err;
