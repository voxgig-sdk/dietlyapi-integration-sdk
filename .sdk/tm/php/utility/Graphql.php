...
// DietlyapiIntegration SDK utility: graphql
//
...
class DietlyapiIntegrationGraphql
{
    ...
    // equivalent.
    public static function body(DietlyapiIntegrationContext $ctx): mixed
    {
    ...
    public static function errors(DietlyapiIntegrationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
