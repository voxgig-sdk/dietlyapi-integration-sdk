...
// DietlyapiIntegration SDK utility: prepare_method

class DietlyapiIntegrationPrepareMethod
{
    ...
    public static function call(DietlyapiIntegrationContext $ctx): string
    {
