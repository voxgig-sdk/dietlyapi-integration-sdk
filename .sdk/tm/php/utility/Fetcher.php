...
// DietlyapiIntegration SDK utility: fetcher

class DietlyapiIntegrationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DietlyapiIntegrationSDK/1.0)';
    ...
    public static function call(DietlyapiIntegrationContext $ctx, string $fullurl, array $fetchdef): array
    {
