...
// DietlyapiIntegration SDK timeout feature
...
class DietlyapiIntegrationTimeoutFeature extends DietlyapiIntegrationBaseFeature
{
    ...
    private function _with_timeout(DietlyapiIntegrationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DietlyapiIntegrationContext $_ctx, float $ms): void
    {
        $client = $this->client;
