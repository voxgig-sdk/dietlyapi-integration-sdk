...
// DietlyapiIntegration SDK audit feature
...
class DietlyapiIntegrationAuditFeature extends DietlyapiIntegrationBaseFeature
{
    ...
    private function _emit(DietlyapiIntegrationContext $ctx, string $outcome): void
    {
