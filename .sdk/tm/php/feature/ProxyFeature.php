...
// DietlyapiIntegration SDK proxy feature
...
class DietlyapiIntegrationProxyFeature extends DietlyapiIntegrationBaseFeature
{
    ...
    public function init(DietlyapiIntegrationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DietlyapiIntegrationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
