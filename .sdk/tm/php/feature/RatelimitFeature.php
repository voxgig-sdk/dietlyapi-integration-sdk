...
// DietlyapiIntegration SDK ratelimit feature
...
class DietlyapiIntegrationRatelimitFeature extends DietlyapiIntegrationBaseFeature
{
    ...
    private function _acquire(DietlyapiIntegrationContext $ctx): void
    {
    ...
    private function _track(DietlyapiIntegrationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
