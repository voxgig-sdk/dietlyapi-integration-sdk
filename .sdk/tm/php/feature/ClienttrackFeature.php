...
// DietlyapiIntegration SDK clienttrack feature
...
class DietlyapiIntegrationClienttrackFeature extends DietlyapiIntegrationBaseFeature
{
    ...
    public function PostConstruct(DietlyapiIntegrationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DietlyapiIntegration-SDK';
