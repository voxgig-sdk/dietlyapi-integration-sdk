...
// DietlyapiIntegration SDK netsim feature
...
class DietlyapiIntegrationNetsimFeature extends DietlyapiIntegrationBaseFeature
{
    ...
    private function _simulate(DietlyapiIntegrationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DietlyapiIntegrationContext $ctx, array $applied): void
    {
        $client = $this->client;
