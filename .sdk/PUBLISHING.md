...
|---|---|---|
| `ts/` | @voxgig-sdk/dietlyapi-integration-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dietlyapi-integration-sdk \
      --repository voxgig-sdk/dietlyapi-integration-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dietlyapi-integration-sdk` shows it, and
`npm trust revoke @voxgig-sdk/dietlyapi-integration-sdk --id=<id>` removes it.
