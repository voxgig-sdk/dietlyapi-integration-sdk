...
describe("FoodEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set DIETLYAPIINTEGRATION_TEST_FOOD_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    local food_ref01_data_dt0_load_result = helpers.to_map(food_ref01_data_dt0_loaded)
...
function food_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("DIETLYAPIINTEGRATION_TEST_FOOD_ENTID")
