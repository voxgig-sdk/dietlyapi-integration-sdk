...
describe("BarcodeDirect", function()
  it("should direct-load-barcode", function()
    local setup = barcode_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-barcode", setup.live and "live" or "unit")
