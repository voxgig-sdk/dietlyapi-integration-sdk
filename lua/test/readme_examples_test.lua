...
local SDK_MODULE = "dietlyapi-integration_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["barcode"] = { ["test01"] = { id = "test01" } }, ["food"] = { ["test01"] = { id = "test01" } }, ["meta"] = { ["test01"] = { id = "test01" } }, ["popular"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } } } }'
