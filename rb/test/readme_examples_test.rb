...
#      offline in seeded test mode (DietlyapiIntegrationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "DietlyapiIntegration_sdk.rb")
  SDK_CLASS = "DietlyapiIntegrationSDK"
  ...
  SDK_BASE = "DietlyapiIntegration_sdk"
